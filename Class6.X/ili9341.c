...
void LCD_barX(unsigned short distance, unsigned short x,unsigned short y,unsigned short c1,unsigned short c2){
int t = 0;
int dmax=100;
while(t<distance){
...
void LCD_barY(unsigned short distance, unsigned short x,unsigned short y,unsigned short c1,unsigned short c2){
int t = 0;
int dmax=100;
while(t<distance){
