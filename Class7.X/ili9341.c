...
void LCDdrawletter(char letter,unsigned short x,unsigned short y,unsigned short c1,unsigned short c2){    
    unsigned short i=0;
    unsigned short j=0;
...
int t = 0;
while(m[t]){
    LCDdrawletter(m[t],x+(5*t),y,c1,c2);
    t++;
    }
}


/*void LCD_barX(int distance, unsigned short x,unsigned short y,unsigned short c1,unsigned short c2){
int t = 0;
int dmax=100;
while(t<distance){
    LCD_drawPixel(x+t,y,c1);
    t++;
    }
while(t<dmax){
    LCD_drawPixel(x+t,y,c2);
    t++;
    }
}*/
...
while(invt>invdmax){
    LCD_drawPixel(x+invt,y,c2);
    invt--;
    }
}

void LCD_barY(int distance, unsigned short x,unsigned short y,unsigned short c1,unsigned short c2){
int t = 0;
int invt = 0;
int dmax=100;
int invdmax=-100;
if (distance>0){
while(t<distance){
    LCD_drawPixel(x,y+t,c1);
    t++;
    }
}
if (distance<0){
while(invt>distance){
    LCD_drawPixel(x,y+invt,c1);
    invt--;
    }
}

while(t<dmax){
    LCD_drawPixel(x,y+t,c2);
    t++;
    }
while(invt>invdmax){
    LCD_drawPixel(x,y+invt,c2);
    invt--;
    }
}