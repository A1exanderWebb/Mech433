...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            signed short tempx=-aX/1600;
            signed short tempY=aY/1600;
            
            count=count+1;
            if (count>50){
                appData.mouseButton[0] = MOUSE_BUTTON_STATE_RELEASED;
                appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
                appData.xCoordinate = (int8_t) tempx;// dir_table[vector & 0x07];
                appData.yCoordinate = (int8_t) tempY;// dir_table[(vector + 2) & 0x07];
                count=1;
            }else{
                appData.mouseButton[0] = MOUSE_BUTTON_STATE_RELEASED;
                appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
